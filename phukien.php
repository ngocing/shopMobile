<?php
	...
	$query = mysqli_query($conn,"select * from sanpham where loai=0");
        ...
        <a id="button"></a>
            ...
            <div class="wrap">
		        ...
		        <div class="cont span_2_of_3">
                                   ...
                                   for($page=0;$page<$sotrang;$page++)
                                     {
                                         ...
                                         {
                                            $n = $page+1;
                                            echo "<li><a href='phukien.php?page=$page' style='color: #7cb022'> $n </a></li>";
                                         }
                                         else
                                         {
                                            $n = $page+1;
                                            echo "<li><a href='phukien.php?page=$page'> $n </a></li>"; 
                                         }
                                      }
                                  ?>
                            </ul>
                    ...
                    <div class="top-box">
                    <?php
					$query=mysqli_query($conn,"select * from sanpham where loai = 0 order by tensp limit ".$bd.", 3");
                                            ...
                                            <div class="price1">
                                            	<?php
                                                	if($r)
													{
                                                        ...
                                                        <span class="actual"><?php echo number_format($r['giakhuyenmai'],"0",",","."); ?>₫</span>
                                                        <?php
													}
													else
													{
