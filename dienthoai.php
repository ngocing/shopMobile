<?php
	...
	$query = mysqli_query($conn,"select * from sanpham where loai=1");
...
<html><!-- InstanceBegin template="/Templates/fontend.dwt.php" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <title>Điện thoại | G1Mobile</title>
        ...
        <a id="button"></a>
            ...
            <div class="wrap">
		        ...
		        <div class="cont span_2_of_3">
                                   ...
                                   for($page=0;$page<$sotrang;$page++)
                                     {
                                         ...
                                         {
                                            $n = $page+1;
                                            echo "<li><a href='dienthoai.php?page=$page' style='color: #7cb022'> $n </a></li>";
                                         }
                                         else
                                         {
                                            $n = $page+1;
                                            echo "<li><a href='dienthoai.php?page=$page'> $n </a></li>"; 
                                         }
                                      }
                                  ?>
                            </ul>
                    ...
                    <div class="top-box">
                    <?php
					$query=mysqli_query($conn,"select * from sanpham where loai = 1 order by tensp limit ".$bd.", 4");
