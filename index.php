...
<html><!-- InstanceBegin template="/Templates/fontend.dwt.php" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <!--start slider -->
            <link rel="stylesheet" href="../Mobile/css/fwslider.css" media="all">
    ...
    <body>   
                ...
                <div class="header-bottom-left">
				    ...
				    <div class="menu">
	                    <ul class="megamenu skyblue">
                            ...
                            <li class="active grid" style="display: inline-block;"><a href="index.php">Trang chủ</a></li>
                            <li style="display: inline-block;"><a href="dienthoai.php">Điện thoại</a></li>
                            <li style="display: inline-block;"><a href="phukien.php">Phụ kiện</a></li>
                            <li style="display: inline-block;"><a href="tintuc.php">Tin tức</a></li>
                            <li style="display: inline-block;"><a href="khuyenmai.php">Khuyến mại</a></li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="wrap"> 
            <div class="wrapfull">
                <div class="wrap-left">
                    <div id="banner1">
                        <div id="sync1" class="owl-carousel owl-theme">
                            <?php
                                $query=mysqli_query($conn,"select hinhanh, tieude1 from banner where loaibanner='ThanhTruot'");
                                while($row = mysqli_fetch_assoc($query))
                                {
                            ?>
                            <div class="item">
                                <a href="#"><img src="<?php echo $row['hinhanh'];?>" alt="<?php echo $row['tieude1'];?>"/></a>
                            </div>       
                            <?php
                                }
                ...
                <div class="wrap-right">
                    <?php
                        $query=mysqli_query($conn,"select distinct hinhanh, tieude1, linkweb from banner where loaibanner='BenCanh' LIMIT 3");
                        while($row = mysqli_fetch_assoc($query))
                        {
                    ?>
                    <div class="bnleft">
                        <a href="<?php echo $row['linkweb'];?>"><img src="<?php echo $row['hinhanh'];?>" alt="<?php echo $row['tieude1'];?>"/></a>
                    </div>
                    <?php
                        }
                        mysqli_free_result($query);
        ...
        <div class="main">
            ...
            <div class="wrap">
		        ...
		        <div class="cont span_2_of_3">
                    <h2 class="head">Sản phẩm được xem nhiều nhất</h2>
                    <div class="top-box">
                    <?php
					$query=mysqli_query($conn,"select * from sanpham order by view DESC limit 0, 4");
					while($row = mysqli_fetch_assoc($query))
					{
                                       	...
                                       	<div class="cart-left">
                                            ...
                                            <div class="price1">
                                            	<?php
													...
													{
                                                        ?>
                                                        <span class="actual"><?php echo number_format($row['giakhuyenmai'],"0",",","."); ?>₫ &nbsp;</span>
                                                        <span class="reducedfrom"><?php echo number_format($row['dongia'],"0",",","."); ?>₫</span>                                                        
                                                        <?php
													}
													else
													{
												?>
                                              			<span class="actual"><?php echo number_format($row['dongia'],"0",",","."); ?>₫</span>
                                                <?php }?>
                                            </div>
                                       	</div>
                    ...
                    <div class="top-box">
                    <?php
					$query=mysqli_query($conn,"select * from sanpham order by view DESC limit 4, 4");
					while($row = mysqli_fetch_assoc($query))
					{
						//$q = mysqli_query($conn,"select giakhuyenmai from khuyenmai where masp ='".$row['masp']."'");
						//$r = mysqli_fetch_assoc($q);
                                       	...
                                       	<div class="cart-left">
                                            ...
                                            <div class="price1">
                                            	<?php
													...
													{
														?>                              
                                                        <span class="actual"><?php echo number_format($row['giakhuyenmai'],"0",",","."); ?>đ &nbsp;</span>
													...
													{
												?>
                                              			<span class="actual"><?php echo number_format($row['dongia'],"0",",","."); ?>đ</span>
                                                <?php }?>
                                            </div>
                                       	</div>
                    ...
                    <div class="top-box">
                    <?php
					$query=mysqli_query($conn,"select * from sanpham order by view DESC limit 8, 4");
					while($row = mysqli_fetch_assoc($query))
					{
						//$q = mysqli_query($conn,"select giakhuyenmai from khuyenmai where masp ='".$row['masp']."'");
						//$r = mysqli_fetch_assoc($q);
                    ...
                    <div class="top-box">
                    <?php
					$query=mysqli_query($conn,"select * from sanpham inner join (SELECT masp,sum(soluong) as tong FROM chitietdonhang group by masp order by tong) as a on (a.masp=sanpham.masp) order by tong DESC limit 0,3");
					while($row = mysqli_fetch_assoc($query))
					{
						//$q = mysqli_query($conn,"select giakhuyenmai from khuyenmai where masp ='".$row['masp']."'");
						//$r = mysqli_fetch_assoc($q);
                    ...
                    <div class="top-box">
                    <?php
					$query=mysqli_query($conn,"select * from sanpham order by ngaynhap DESC limit 0, 3");
					while($row = mysqli_fetch_assoc($query))
					{
						//$q = mysqli_query($conn,"select giakhuyenmai from khuyenmai where masp ='".$row['masp']."'");
						//$r = mysqli_fetch_assoc($q);
        ...
        <script  src="../Mobile/js/sliderFinal.js"></script>
    </body>
<!-- InstanceEnd --></html>