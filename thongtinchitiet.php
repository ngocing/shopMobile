<?php
	...
	{
		$taikhoan =$_POST['txttaikhoan'];$taikhoan= mysqli_real_escape_string($conn, $taikhoan);
		$hoten=$_POST['txthoten'];$hoten= mysqli_real_escape_string($conn, $hoten);
		$diachi=$_POST['txtdiachi'];$diachi= mysqli_real_escape_string($conn, $diachi);
		$email=$_POST['txtemail'];$email= mysqli_real_escape_string($conn, $email);
		$sdt=$_POST['txtsdt'];$sdt= mysqli_real_escape_string($conn, $sdt);
...
<html><!-- InstanceBegin template="/Templates/fontend.dwt.php" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <title>Thông tin chi tiêt tài khoản | G1Mobile</title>
		        ...
		        <div class="cont span_2_of_3">
                        <div class="register_account">
							<div class="wrap">
                                ...
                                <form action="thongtinchitiet.php" method="post" name="themsp" enctype="multipart/form-data">
...
?>
                                    ...
                                    <div style="margin-left: 100px;"><button name="doimatkhau" class="grey">Đôi mật khẩu</button></div>
