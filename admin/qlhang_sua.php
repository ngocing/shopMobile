<?php
	...
	{
		header("Location:qlhang.php");
	}
	$loima = "";
	$loiten = "";
	$query = mysqli_query($conn, "select * from hang where mahang = '$mahang'");
	...
	if(isset($_POST['submit']))
	{
		...
		if($ma != "" && $ten != "")
		{
			...
			if(mysqli_num_rows($query1) == 0 || $mahang == $ma)
			{
				mysqli_query($conn, "update hang set mahang='".$ma."', tenhang='".$ten."' where mahang ='".$mahang."'");
...
<html><!-- InstanceBegin template="/Templates/backend.dwt.php" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <title>Sửa hãng sản phẩm | HaHaMobile</title>
    ...
    <body>
		...
		<div class="register_account">
            <div class="wrap">
                ...
                <form action="qlhang_sua.php?mahang=<?php echo $mahang;?>" method="post" style="height:510px">
                    ...
                    <div class="clear"></div>
                    <button name="submit" class="grey">Sửa</button>
