<?php
	...
	if(isset($_POST['submit']))
	{
		...
		if($taikhoan != "Bắt buộc")
		{
			if($matkhau != "Bắt buộc")
			{
				if($nhaplaimk != "Bắt buộc")
				{
					if($hoten != "Bắt buộc")
					{
						if($loi == "")
						{
							$q = mysqli_query($conn, "select * from taikhoan where taikhoan ='$taikhoan'");
							$r = mysqli_num_rows($q);
							if($r == 0)
							{
								mysqli_query($conn,"INSERT INTO taikhoan(taikhoan, matkhau,hoten,ngaysinh,gioitinh,diachi,email,sdt,quyen) values('$taikhoan','$matkhau','$hoten','$ngaysinh','$gioitinh','$diachi','$email','$sdt','$quyen')");
		...
		<!-- InstanceBeginEditable name="body" -->
                        <div class="register_account">
							<div class="wrap">
                                ...
                                <form action="qluser_them.php" method="post" name="themsp" enctype="multipart/form-data" style="height:510px">
                                    <div class="col_1_of_2 span_1_of_2">
                                        ...
                                        <div><input type="text" name = "txtmatkhau" value="<?php echo $matkhau;?>" onfocus="if (this.value == 'Bắt buộc'){ this.value = ''; this.type ='password';}" onblur="if (this.value == '') {this.value = 'Bắt buộc'; this.type ='text';}"></div>
                                        <p class="code">Nhập lại mật khẩu</p>
                                        <div><input type="text" name = "txtnhaplaimk" value="<?php echo $nhaplaimk;?>" onfocus="if (this.value == 'Bắt buộc'){ this.value = ''; this.type ='password';}" onblur="if (this.value == '') {this.value = 'Bắt buộc'; this.type ='text';}"></div>
...
<?php
												...
												{
													$a=mysqli_query($conn,"select * from phanquyen ");
												  	while ($row=mysqli_fetch_assoc($a))
												  	{
?>
                                                     	<option value="<?php echo $row['maquyen'];?>"><?php echo $row['tenquyen']; ?></option>
