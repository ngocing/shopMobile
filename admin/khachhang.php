...
?>
<h2 class="head"><?php if($key == "") echo "Tất cả khách hàng(".$num.")"; else echo "Kết quả cho'$key'($num)"?></h2>
...
?>
                                <tr>
                                    ...
                                    <td><a href="qlkhachhang_xoa.php?matk=<?php echo $dong['taikhoan']?>">Xóa</a></td>
                                </tr>
<?php
    }
?>
