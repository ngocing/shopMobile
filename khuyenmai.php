        ...
        <a id="button"></a>
            ...
            <div class="wrap">
		        ...
		        <div class="cont span_2_of_3">
                    <h2 class="head">Sản phẩm khuyến mại</h2>
                                   ...
                                   for($page=0;$page<$sotrang;$page++)
                                     {
                                         ...
                                         {
                                            $n = $page+1;
                                            echo "<li><a href='khuyenmai.php?page=$page' style='color: #7cb022'> $n </a></li>";
                                         }
                                         else
                                         {
                                            $n = $page+1;
                                            echo "<li><a href='khuyenmai.php?page=$page'> $n </a></li>"; 
                                         }
                                      }
                                  ?>
                            </ul>
                    ...
                    <?php
					//$bd = $bd + 3;
					$query=mysqli_query($conn,"select * from sanpham where giakhuyenmai != 0 order by tensp limit ".$bd.", 4");
					...
					while($row = mysqli_fetch_assoc($query))
					{
						//$q = mysqli_query($conn,"select giakhuyenmai from khuyenmai");
						//$r = mysqli_fetch_assoc($q);
                    ?>
			 			<div class="col_1_of_3 span_1_of_3"> 
                        	<a href="chitietsanpham.php?masp=<?php echo $row['masp'];?>">
