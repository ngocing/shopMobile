<?php
	...
	$query = mysqli_query($conn,"select * from tintuc");
        ...
        <a id="button"></a>
            ...
            <div class="wrap">
		        ...
		        <div class="cont span_2_of_3">
                    ...
                    <div class="login1">
                    <h5 class="m_6">Tin tức (<?php echo $num?>)</h5>
                    <div class="mens-toolbar">
                                   ...
                                   for($page=0;$page<$sotrang;$page++)
                                     {
                                         ...
                                         {
                                            $n = $page+1;
                                            echo "<li><a href='tintuc.php?page=$page' style='color: #7cb022'> $n </a></li>";
                                         }
                                         else
                                         {
                                            $n = $page+1;
                                            echo "<li><a href='tintuc.php?page=$page'> $n </a></li>"; 
                                         }
                                      }
                                  ?>
                            </ul>
                     ...
                     <?php
					$query=mysqli_query($conn,"select * from tintuc order by ngaydang limit ".$bd.", 10");
                    ...
                    ?>
                        ...
                        <h5 class="m_6"><a href="tintucchitiet.php?id=<?php echo $row['id'];?>"><?php echo $row['tieude']?></a></h5>
                       	<p class="m_text"><?php echo date("d-m-Y", strtotime($row['ngaydang']));?></p>
                        <p class="m_text"><?php echo $row['tomtat']?></p>
